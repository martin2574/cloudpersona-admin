        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b bg-muted/50">
              {columns.map((col) => (
                <th
                  ...
                  className={cn(
                    ...
                    col.sortable !== false && onSort && "cursor-pointer select-none hover:text-foreground"
                  )}
              ...
              {actions && <th className="h-10 px-4 text-right font-medium text-muted-foreground w-24">Actions</th>}
            </tr>
          </thead>
          <tbody>
            {data.length === 0 ? (
